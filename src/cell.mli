...
val life : t -> int (** Total life of the cell **)
val damage : t -> int (** Current damage that the cell has experienced. If damage > life, the cell is dead. **)

val energy : t -> int (** Current energy the cell has. **)

val delay : t -> int (** Current delay of a cell, which is removed from the time it can compute at this turn. **)
